 ...
 * single dotted-key table block (`[mcp_servers.springgraph]`) inside an
 ...
 *
 * Strategy: treat the file as text. Find the `[mcp_servers.springgraph]`
 ...
 *     the full dotted key `[mcp_servers.springgraph]`).
