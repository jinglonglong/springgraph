-- Migration 001: Create the 8 springkg data tables
-- (schema_versions already exists from schema.sql / initialize())
...
CREATE TABLE IF NOT EXISTS spring_symbols (
    ...
    end_line INTEGER,
    metadata TEXT,                                 -- JSON
    confidence REAL DEFAULT 1.0,                   -- 0.0-1.0, default 1.0
