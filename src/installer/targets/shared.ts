...
import {
  SPRINGGRAPH_INSTRUCTIONS_BLOCK,
  SPRINGGRAPH_SECTION_START,
  SPRINGGRAPH_SECTION_END,
} from '../instructions-template';

/**
 * The MCP-server config block springgraph injects. Same shape across
 ...
 */
export function getSpringgraphPermissions(): string[] {
  return [
    'mcp__springgraph__springgraph_explore',
 ...
 *
 * Used by Claude / Codex for the `<!-- SPRINGGRAPH_START --> ... <!--
 * SPRINGGRAPH_END -->` block. Preserves all content outside the
 * markers verbatim.
 *
...
/**
 * Upsert the Springgraph instructions block into an agent instructions
