...
const explore = subCounts['mcp__springgraph__springgraph_explore'] || mainCounts['mcp__springgraph__springgraph_explore'] || 0;
...
console.log(`\nVERDICT: springgraph_explore used ${explore}x | Read ${reads} | Grep/Bash ${greps}`);
