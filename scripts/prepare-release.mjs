...
/**
 * Append a `[X.Y.Z]: https://github.com/jinglonglong/springgraph/releases/tag/vX.Y.Z`
...
function appendLinkRef(text, version) {
  const refLine = `[${version}]: https://github.com/jinglonglong/springgraph/releases/tag/v${version}`;
